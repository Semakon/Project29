...
public class TherapistAssist {
     ...
     * @return true if Client was added successfully, false if the currentUser does not exist.
     */
    public boolean addClient(User currentUser, String name) {
        for (User u : users) {
            if (currentUser.equals(u)) {
                currentUser.addClient(name, null);
                return true;
            }
        }
        return false;
